...
q_A = portion_liner(time_point(1:2), sample_rate, T, delta_B, noap_B);
% linear portion
...
q_B = portion_accelerated(time_point(2:3), sample_rate, T, t_acc, theta_A2, noap_B, noap_C);
% accelerated portion
...
q_C = portion_liner(time_point(3:4), sample_rate, T, delta_C, noap_B);
% linear portion
